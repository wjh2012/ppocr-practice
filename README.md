...
# 테스트 스크립트
python app/lmdb_dataset/run_json.py --lmdb_path /home/taehwa/data_test/lmdb_train
python app/lmdb_dataset/run_json.py --lmdb_path /home/taehwa/data_test/lmdb_val
```
